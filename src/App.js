...
function App() {
  ...
  const PROJECTS = [
    ...
    { name: 'Portfólio', tags: 'React, JavaScript, HTML, CSS, Bootstrap', desc: 'Portfólio simples para showcase de projetos no GitHub Pages. Responsívo e escalável, também incorpora um visualizador de imagens. Foram utilizados React e Bootstrap para me ajudar a aprendê-los.', folder: 'folio', imgs: ['folio-thumb.png'] },
    ...
    { name: 'Infográficos', tags: 'Design', desc: 'Diversos infográficos produzidos ao longo da graduação. Para todos foram utilizados Illustrator e Photoshop, com um deles sendo um infográfico interativo produzido na ferramenta Protopie. Em todos contribui ativamente durante a concepção e produção.', link: 'https://bit.ly/304a7rt', folder: 'infografx', imgs: ['eu-1.png', 'comp-1.jpeg', 'color-1.png', 'color-2.jpg', 'color-3.png', 'waste-1.png'] }
  ]
